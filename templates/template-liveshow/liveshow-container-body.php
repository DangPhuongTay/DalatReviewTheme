    ...
    <div class="liveshow__container--body__product">
        <div class="liveshow__container--body__product--filter">
            <div class="liveshow__container--body__product--filter__price--wrap">
                ...
                <form method="get" name="form" action="<?php echo home_url();?>/<?php echo request();?>" >
                        <div class="search">
                            <select class="liveshow__container--body__product--filter__price--poptip__option" name="price"  onChange="this.form.submit();">
                            <option class="liveshow__container--body__product--filter__price--poptip__option" value="" selected>Giá sản phẩm</option>
                            <option class="liveshow__container--body__product--filter__price--poptip__option" value="ASC" >Giá (thấp đến cao)</option>       
                            <option class="liveshow__container--body__product--filter__price--poptip__option" value="DESC" >Giá (cao đến thấp)</option>   
                            </select>
                        </div>
