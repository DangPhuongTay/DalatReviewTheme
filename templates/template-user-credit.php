                    ...
                    <div class="user__credit--history__box">
                        ...
                        <div class="user__credit--transactions">
                            <div class="user__credit--transactions__banner">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_credit_banner.webp" alt="" srcset="">
            ...
            <div class="user__mb--gift__card user__mb--nogGift__card">
                <div class="user__mb--gift__card--introduction">
                    <div class="user__mb--gift__card--banner__container">
                        <!-- <img src="/assets/img/user_gift_card_banner.jpg" alt=""> -->
                        <h1 class="title">Phiếu quà tặng Đà Lạt Review</h1>
                        <button class="button"> Mua ngay</button>
                    </div>
                    <div class="user__mb--gift__card--banner__advantages">
                        <!-- item 1 -->
                        <div class="user__mb--gift__card--banner__advantages--items">
                            <div class="icon"></div>
                            <div class="content">
                        ...
                        <div class="user__mb--gift__card--banner__advantages--items">
                            ...
                            <div class="content">
                                ...
                                <div class="description">Bạn chưa có kế hoạch? Đừng lo lắng - hãy dùng phiếu quà tặng bất cứ lúc nào</div>
                            </div>
                        </div>
                        <!-- item 3 -->
                        <div class="user__mb--gift__card--banner__advantages--items">
