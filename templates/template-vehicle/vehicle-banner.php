<div class="motorbike__container--banner">
        <img src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'thumnail'); ?>"/>
            ...
            if ( $sub_cats ) {
                ...
                foreach( $sub_cats as $sub_category ) { ?>
                        <div style="text-transform:uppercase;" class="motorbike__container--banner__box--item" >
                          <a href="<?php echo home_url() ?>/<?php echo $sub_category->slug ?>" class="cart__container--top__left--all__left--check"><?php echo $sub_category->name ?>
