                        ...
                        <div>
                            ...
                            <div class="user__gift--card__benefit">
                                ...
                                <div class="user__gift--card__benefit--items">
                                    <div class="user__gift--card__benefit--icon user__benefit--icon1">
                                    </div>
                                ...
                                <!-- item2 -->
                                <div class="user__gift--card__benefit--items">
                                    <div class="user__gift--card__benefit--icon user__benefit--icon2">
                                    </div>
                                    <div class="user__gift--card__benefit--content">
                                        <div class="user__gift--card__benefit--title">
                                ...
                                <!-- item3 -->
                                <div class="user__gift--card__benefit--items">
                                    <div class="user__gift--card__benefit--icon user__benefit--icon3">
                                    </div>
                                    <div class="user__gift--card__benefit--content">
                                        <div class="user__gift--card__benefit--title">
                                            Rất quyền năng
                                ...
                                <div class="user__gift--card__benefit--items">
                                    <div class="user__gift--card__benefit--icon user__benefit--icon4">
                                    </div>
                                    <div class="user__gift--card__benefit--content">
                                        <div class="user__gift--card__benefit--title">
                            ...
                            <div class="user__gift--card__share">
                                ...
                                <div class="another__person--container">
                                    <div class="wrapper">
                                        <div class="user__gift--card__another--item user__family1">
                                    ...
                                    <!-- item 2 -->
                                    <div class="wrapper">
                                        <div class="user__gift--card__another--item user__family2">
                                    ...
                                    <!-- item 3 -->
                                    <div class="wrapper">
                                        <div class="user__gift--card__another--item user__family3">
                            ...
                            <div class="user__gift--card__explore">
                                ...
                                <div class="adv__img--container">
                                    <div class="adv__img--item">
                                        <div class="image user__gift--card__explore--img1">
                                        </div>
                                        <div class="desc">Tham quan & giải trí </div>
                                    </div>
                                    <div class="adv__img--item">
                                        <div class="image user__gift--card__explore--img2"></div>
                                        <div class="desc">Di chuyển </div>
                                    </div>
                                    <div class="adv__img--item">
                                        <div class="image user__gift--card__explore--img3"></div>
                                        <div class="desc">Lưu trú & nghỉ dưỡng </div>
                                    </div>
                                    <div class="adv__img--item">
                                        <div class="image user__gift--card__explore--img4"></div>
                                        <div class="desc">Ẩm thực & Nhà hàng </div>
                                    </div>
                                    <div class="adv__img--item">
                                        <div class="image user__gift--card__explore--img5"></div>
                            ...
                            <div class="user__gift--card__redeem--container">
                                <div class="user__gift--card__redeem">
                                    ...
                                    <div class="user__gift--card__redeem--right">
                                        <div class="user__gift--card__img--input">
            ...
            <div class="user__mb--gift__card--introduction">
                ...
                <div class="user__mb--gift__card--propositions">
                    <div class="propositions__items">
                        <div class="item">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_gif-benefit_1.png" alt="" srcset="">
                            </div>
                            <div class="content">
                    ...
                    <div class="propositions__items">
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_gif-benefit_2.png" alt="" srcset="">
                            </div>
                            <div class="content">
                    ...
                    <div class="propositions__items">
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_gif-benefit_3.png" alt="" srcset="">
                            </div>
                            <div class="content">
                    ...
                    <div class="propositions__items">
                        ...
                        <div class="item">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_gif-benefit_4.png" alt="" srcset="">
                            </div>
                            <div class="content">
                ...
                <div class="user__mb--gift__card--audience">
                    ...
                    <div class="image__container">
                        <div class="image__item">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_another_ps1.jpg" alt="" srcset="">
                ...
                <div class="user__mb--gift__card--explore">
                    ...
                    <div class="image__container">
                        <div class="image__items">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_explore1.png" alt="" srcset="">
                            <div class="description">Tham gia & giải trí </div>
                        </div>
                        <div class="image__items">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_explore2.png" alt="" srcset="">
                            <div class="description">Tham gia & giải trí </div>
                        </div>
                        <div class="image__items">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_explore3.png" alt="" srcset="">
                            <div class="description">Tham gia & giải trí </div>
                        </div>
                        <div class="image__items">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_explore4.png" alt="" srcset="">
                            <div class="description">Tham gia & giải trí </div>
                        </div>
                        <div class="image__items">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_explore5.png" alt="" srcset="">
                            <div class="description">Tham gia & giải trí </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="user__mb--gift__card--buynow">
                <div class="card__buynow--container">
                    ...
                    <div class="right__banner">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user_gift_card_mb.png" alt="" srcset="">
                    </div>
                </div>
            </div>
