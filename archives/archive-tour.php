<?php
    ...
    <div class="tour">
        <!--! banner -->
        <div class="tour__banner" style="background-image: url('<?php echo get_template_directory_uri( )?>/assets/images/blog-banner.png');">
                        ...
                        <div class="firstProduct__content--list__item--wrap">
                            <a href="http://localhost/wordpress/tour/detail-tour/" class="">
                                <div class="firstProduct__img">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tourProduct8.webp" alt="tourProduct">
                                </div>
                                        ...
                                        <div class="tagging__wrap">
                                            <div class="tagging__box">
                                                <div class="tagging__tag">
                                                    <span class="tagging__tag--text"><?php the_author_posts_link(); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
